...
4. Root finding: The problem, fixed-point iteration, bisection method, Newton-Raphson method (1-D), Newton-Raphson method (n-D), Jacobian matrix, pseudo-inverse, secant method, Broyden, `scipy.optimize.minimize` 
